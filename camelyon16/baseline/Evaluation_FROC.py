...
if __name__ == "__main__":
    ...
    result_folder = 'datasets/test/dens_map_sampling_2s_l6/model_prior_o0.25_l1/save_pack_roi_th_0.1_itc_th_1e0_1e3_canvas_800_patch_256_whole_dynmodel_fixsize_parent_l3'
    threshold = 0.5
