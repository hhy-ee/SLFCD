...
if __name__ == "__main__":
    ...
    # result_folder = 'datasets/test/prior_map_sampling_o0.5_l1'
    result_folder = 'datasets/test/dens_map_sampling_2s_l6/model_prior_o0.5_l1/save_stage2_roi_th_0.1_itc_th_1e0_1e9_canvas_800_patch_256_shuffle_False_sparsity_0.125_whole_region_fix_model_l3'
    threshold = 0.5
