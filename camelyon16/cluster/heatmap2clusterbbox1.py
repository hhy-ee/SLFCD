...
def parse_args():
    ...
    parser.add_argument('json_path', default=".", help='the path for box of interest data of json format')
    parser.add_argument('dens_path', default=".", help='the path for density_map data of json format')
...
if __name__ == "__main__":
    ...
    for file_name in tqdm(candidates.keys(), total=len(candidates.keys())):
        ...
        size_scale = tuple([int(i / 2**output_level) for i in slide.level_dimensions[0]])
